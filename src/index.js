...
app.post('/multiply',(req,res)=>{
    const num1=req.body.num1;
    const num2=req.body.num2;
    res.send({status: "success",message:typeof num1==='string'|| typeof num2=== "string"?"Invalid data types": result<-1000000?"Underflow":result>1000000?"Overflow":"The product of given numbers",sum:num1*num2});
})
...
app.post('/divide',(req,res)=>{
    ...
    const num2=req.body.num2;
    result=num1/num2;
    res.send({status: num2===0?"error":"success",message:typeof num1==='string'|| typeof num2=== "string"?"Invalid data types": num2===0?"Cannot divide by zero":"The division of given numbers",sum:result});
})
